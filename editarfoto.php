                        ...
                        <div class="widget js-widget widget--landing">
                          ...
                          <h5 class="widget__headline">Aquí puede agregar o eliminar propiedades.</h5><br><br><br>
                            ...
                            if(isset($_POST['Ir'])){
                              ...
                              if($accion=='Agregar') {
                                 echo' <form action="modificarfoto.php" method="post" enctype="multipart/form-data">
                                 Imagen <input type="file" name="imagen" id="imagen"> <p>*Este archivo debe ser .jpg, .jpeg, .gif, .png</p>
                            ...
                            $sql1 = mysql_query("SELECT * FROM `imagenes` WHERE `direccion`='".$direccion."'", $db);
                            
                            while($result= mysql_fetch_assoc($sql1)){?>  
                             <td style="width:25%; height:25%"><img style="width:75%; height:50%" src="../../imagen.php?imagen_id=<?php echo $result["imagen_id"];?>"/></td><?php
                             echo "<td><a href='modificarfoto.php?id=".$result['imagen_id']."&direccion=".$result['direccion']."'> Eliminar</a></td>";  
                            ?></tr>
                            <?php } ?>
                           </table><?php
                            }

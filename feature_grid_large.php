          ...
          <div class="container">
              ...
              <div class="site site--main">
                ...
                <div class="site__panel">
                  ...
                  <div class="listing__view"><span class="control-label">Vista:</span>
                    <a href="feature_grid_large.php" class="btn--white active"><i class="fa fa-th-large"></i></a>
                    <a href="properties_listing_list.php" class="btn--white"><i class="fa fa-bars"></i></a>
                    <a href="properties_listing_table.php" class="btn--white"><i class="fa fa-table"></i></a>
                  </div>
                    ...
                    <div class="widget__content">
                      <div class="listing listing--grid listing--lg-6 js-properties-list">
                       <?php
							...
							$areamin = $_SESSION['inareafrom'];
							$areamax = $_SESSION['inareato'];
                  		...
                  		$result = mysql_query("SELECT * FROM `propiedades`  WHERE `tipo` ='".$tipo."' AND `comuna` ='".$comuna."'
								AND `contrato` ='".$contrato."' AND `precio`>=".$preciomin." AND `precio`<=".$preciomax."
								AND `area`>=".$areamin." AND `area`<=".$areamax."", $db);
			...
			<div class="sidebar">
                <div class="widget js-widget widget--sidebar">
                  ...
                  <div class="widget__content">
                    <!-- BEGIN SEARCH-->
                    <form action="properties_listing_list.php" method="POST" class="form form--flex form--search js-search-form form--sidebar">
              <div class="row">

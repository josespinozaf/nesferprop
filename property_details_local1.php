...
$result = mysql_query("SELECT * FROM `propiedades`  WHERE `id` =".$id."", $db);
	...
	?>							
                    ...
                    <div class="widget__content">
                      <div class="map map--properties">
                        <div class="map__buttons">
                          <button type="button" class="map__change-map js-map-btn active">Mapa de la propiedad</button>
                          <button type="button" class="map__change-panorama js-panorama-btn">Street view</button>
                        </div>
                        <div class="map__wrap">
                          <div data-type="map" class="map__view js-map-canvas-local1"></div>
              ...
              <div class="row">
                ...
                <div class="form-group">
                  <label for="in-bedrooms-type" class="control-label">Habitaciones</label>
                      ...
                      <div class="region-select">
                        <ul class="js-checkboxes-tree bonsai region-select__list">
                          <li>
                            ...
                            <ul>
                              <li>
                                <input type="checkbox" name="location[]" value="Rauco" id="region-select-states-1" class="in-checkbox">
                                <label for="region-select-states-1" data-toggle="tooltip" data-placement="top" title="Rauco" class="in-label">Rauquén</label>
                              </li>
                              <li>
                                <input type="checkbox" name="location[]" value="Centro" id="region-select-states-2" class="in-checkbox">
                                <label for="region-select-states-2" data-toggle="tooltip" data-placement="top" title="Ccentro" class="in-label">Centro</label>
                              </li>
                              <li>
                                <input type="checkbox" name="location[]" value="Avenida España" id="region-select-states-3" class="in-checkbox">
                                <label for="region-select-states-3" data-toggle="tooltip" data-placement="top" title="Avenida España" class="in-label">Avenida España</label>
                              </li>
                            </ul>
                          </li>
                          <li>
                            <input type="checkbox" name="location[]" value="Los Angeles" id="region-select-states-4" class="in-checkbox">
                            <label for="region-select-states-4" data-toggle="tooltip" data-placement="top" title="Los Angeles" class="in-label">Molina</label>
                            <ul>
                              <li>
                                <input type="checkbox" name="location[]" value="Santa Elvira" id="region-select-states-5" class="in-checkbox">
                                <label for="region-select-states-5" data-toggle="tooltip" data-placement="top" title="Santa Elvira" class="in-label">Santa Elvira</label>
                              </li>
                ...
                <div class="form-group">
                  ...
                  <div class="form__inputs js-search-inputs">
                    <input type="text" id="in-price-from" placeholder="Desde" data-input-type="from" class="form-control js-field-range">
                    <input type="text" id="in-price-to" placeholder="Hasta" data-input-type="to" class="form-control js-field-range">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="form__inputs js-search-inputs">
                    <input type="text" id="in-area-from" placeholder="Desde" data-input-type="from" class="form-control js-field-range">
                    <input type="text" id="in-area-to" placeholder="Hasta" data-input-type="to" class="form-control js-field-range">
                  </div>
                </div>
                        ...
                        <form action="#" class="form form--flex form--auth js-login-form js-parsley">
                          <div class="row">
                            <div class="form-group">
                              ...
                              <input type="text" name="username" id="login-username-dropdown" required data-parsley-trigger="keyup" data-parsley-minlength="6" data-parsley-validation-threshold="5" data-parsley-minlength-message="El ingreso debe contener al menos 6 caracteres" class="form-control">
                            </div>
                             <div class="form-group">

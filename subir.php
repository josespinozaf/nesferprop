...
if(isset($_POST['IngresarPropiedadUF'])){
$direccion= $_REQUEST['direccion'];
$tipo1= $_REQUEST['tipo'];
$contrato= $_REQUEST['contrato'];
$precioUF= $_REQUEST['precioUF'];
$area= $_REQUEST['area'];
...
//comprobamos si ha ocurrido un error.
	...
	$resultado1 = mysql_query("INSERT INTO `propiedades`(`direccion`, `tipo`, `contrato`, `preciouf`, `area`, `mconstruidos`, `anoconstruccion`, `comuna`, `descripcion`, `habitaciones`, `banos`)
			VALUES ('".$direccion."','".$tipo1."','".$contrato."',".$precioUF.",".$area.",".$mconstruidos.",".$añoconstruccion.",'".$comuna."','".$descripcion."',".$habitaciones.",".$baños.")", $db);
	 } 
	 if ($resultado1){

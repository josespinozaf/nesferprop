...
(function ($) {
  ...
  app.initTheme({
    ...
    colorTheme: 'dark_blue-dark_yellow',
   ...
   */
  var mapOptions = {
    center: new google.maps.LatLng(-34.9803976, -71.2402775),
  ...
  initIndexMap('.js-map-index-canvas', {lat: -34.983111, lng: -71.229640});
  initIndexMap('.js-map-canvas-fullscreen', {lat: -34.983111, lng: -71.229640});
  initPropertyMapAndPanorama('.js-map-canvas[data-type="map"]', '.js-map-canvas[data-type="panorama"]', {lat: -34.983111, lng: -71.229640});
  ...
  initGoogleMap('.js-map-canvas-contact', {lat: -34.983111, lng: -71.229640});
  initGoogleMap('.js-map-canvas-local1', {lat: -34.977586, lng: -71.243690});
  initGoogleMap('.js-map-canvas-sitio1', {lat: -34.977586, lng: -71.243690});
  initBtnDemo('.js-btn-demo');
  initPopovers('.js-popover');
  initGeocoderGoogleMap('.js-map-location-dashboard-submit', {lat: -34.983111, lng: -71.229640});
  initGeocoderGoogleMap('.js-map-location-dashboard', {lat: -34.983111, lng: -71.229640});
  initGeocoderGoogleMap('.js-map-location-dashboard-hidden', {lat: -34.983111, lng: -71.229640});
  initLeafletMap('.js-map-canvas-leaflet', {lat: -34.983111, lng: -71.229640});
  ...
  function initSubscribe (container) {
    ...
    $subscribeForm
      ...
      .on('form:success', function (formInstance) {
        app.notifier.showSuccess('¡Te has suscrito satisfactoriamente!');
        return false;
      })
      .on('form:error', function (formInstance) {
        app.notifier.showError('¡Suscripción fallida! Por favor, intenta nuevamente.');
        return false;
      });
  }
  ...
  function initGoogleMap(container, location) {
    ...
    (function () {
      ...
      app.createMap(
         ...
         */
        function () {
          var map = new google.maps.Map($mapCanvas[0], _.merge(mapOptions, {zoom: 13, coordinates : coordinates }));
    ...
    $form
      .each(function () {
        ...
        $(this)
          .parsley()
          .on('form:success', function (formInstance) {
            app.notifier.showSuccess('¡Has enviado satisfactoriamente el formulario!');
            return false;
          })
          .on('form:error', function (formInstance) {
            app.notifier.showError('¡Envío fallido! Por favor, intenta nuevamente.');
            ...
            function (results, status) {
              if (status == google.maps.GeocoderStatus.OK) {
                if (results[0]) {
                  ...
                  $autocompleteAddress[0].value = "No hay resultados";
                }
              }
              else {

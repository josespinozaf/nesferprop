              ...
              <div class="site site--main">
                ...
                <div class="site__panel">
                  ...
                  <div class="listing__view"><span class="control-label">Vista:</span>
                    <a href="feature_grid_large.php" class="btn--white"><i class="fa fa-th-large"></i></a>
                    <a href="properties_listing_list.php" class="btn--white"><i class="fa fa-bars"></i></a>
                    <a href="properties_listing_table.php" class="btn--white active"><i class="fa fa-table"></i></a>
                  </div>
                      ...
                      <div class="datatable datatable--properties">
                        <div class="datatable__wrap">
                          <table class="js-properties-table datatable__table">
                            <thead>
                              <tr>
                                <th class="datatable__head-1">Dirección</th>  
                                <th class="datatable__head-2 datatable__head-sort">Contrato</th>                             
                                <th class="datatable__head-3 datatable__head-sort">Precio $</th>
                                <th class="datatable__head-4 datatable__head-sort">Tipo</th>
